...
return [
    ...
    */
    ...
    |            "postmark", "resend", "textmagic", "log", "array",
    |            "failover", "roundrobin"
    |
    */
    ...
    'mailers' => [
        ...
        'transactional' => [
            'transport' => env('MAIL_TRANSACTIONAL_TRANSPORT', 'log'),
            'textmagic' => [
                'sender_id' => env('TEXTMAGIC_TRANSACTIONAL_EMAIL_SENDER_ID'),
                'from_name' => env('TEXTMAGIC_TRANSACTIONAL_FROM_NAME'),
                'reply_to' => env('TEXTMAGIC_TRANSACTIONAL_REPLY_TO'),
            ],
        ],
        ...
        'handcrafted' => [
            ...
            'textmagic' => [
                ...
                'reply_to' => env('TEXTMAGIC_HANDCRAFTED_REPLY_TO'),
            ],
        ],
