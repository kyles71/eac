...
final class OpenEnrollmentReminderEmailType implements EmailTypeContract
{
    public function definition(): EmailTypeDefinition
    {
        return new EmailTypeDefinition(
            ...
            subjects: ['en' => 'Complete your {{ open_enrollments.count }} open enrollment(s)'],
            bodies: ['en' => <<<'HTML'
                <p>Hello {{ user.first_name }},</p>
                <p>Please complete the next steps for the following enrollment(s) by assigning a student:</p>
