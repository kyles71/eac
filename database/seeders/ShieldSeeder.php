...
final class ShieldSeeder extends Seeder
{
    public function run(PermissionCatalogSynchronizerService $synchronizer): void
    {
        ...
        $owner->givePermissionTo([
            Permission::findByName('Create:Board', 'web'),
            Permission::findByName('Create:StaffNote', 'web'),
            Permission::findByName('Delete:Board', 'web'),
            ...
            Permission::findByName('RetryPayment:PaymentPlan', 'web'),
            Permission::findByName('Send:Email', 'web'),
            Permission::findByName('SendPaymentLink:PaymentPlan', 'web'),
            ...
            Permission::findByName('View:Board', 'web'),
            Permission::findByName('View:BoardItem', 'web'),
            Permission::findByName('View:Event', 'web'),
            Permission::findByName('View:StaffNote', 'web'),
            Permission::findByName('View:Student', 'web'),
            Permission::findByName('ViewAny:Board', 'web'),
            Permission::findByName('ViewAny:BoardItem', 'web'),
